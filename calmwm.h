...
#define CLIENT_DOCKED		   0x10000

#define CLIENT_SKIP_CYCLE		(CLIENT_HIDDEN | CLIENT_IGNORE | CLIENT_SKIP_TASKBAR | CLIENT_SKIP_PAGER | CLIENT_DOCKED)
...
void			 group_raise(struct screen_ctx *, int);
...
void			 kbfunc_group_raise(void *, struct cargs *);
